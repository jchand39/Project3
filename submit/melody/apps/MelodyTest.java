...
public class MelodyTest {
     ...
     */
    @Test
    public void testReverseWithNullSong() {
        Melody melody = new Melody(null, "Title", "Artist", 0);
        boolean result = melody.reverse();
    ...
    public void testReverseWithEmptySong() {
        ...
        boolean result = melody.reverse();
        assertFalse("reverse() should return false for empty song", result);
    }
    /**
     * Test of reverse method, of class Melody.
     * Case 1
